...
<task type="auto">
  ...
  <action>
    ...
    **3. Landing Page (src/app/page.tsx):**
    ...
    Replace the verification page with a proper landing page Server Component. Use the frontend-design skill (requirement UI-06) to create a high-quality layout:
        ...
        <main className="mx-auto max-w-3xl px-6 py-16 sm:py-24">
          ...
          <div className="space-y-3">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed max-w-xl">
              10 weekends. Real AI skills. Track your progress from first vibe code to deployed AI tool.
            </p>
          </div>
              ...
              >
                <div className="flex items-baseline gap-4">
                  <span className="text-sm font-medium text-muted-foreground tabular-nums">
                    {w.isBonus ? 'Bonus' : String(w.number).padStart(2, '0')}
                  </span>
          ...
          <p className="mt-16 text-center text-sm text-muted-foreground">
            Built during Weekend 1 — The Vibe Code Kickoff
          </p>
        </main>
      );
    }
    ...
    - Generous whitespace (py-16/py-24, mt-16, space-y-4)
    - Clean typography (font-semibold for headings, text-muted-foreground for secondary text)
    - Subtle interaction (hover:bg-accent/50 on cards)
    - No clutter — just number, name, deliverable per card
    - Mobile-first responsive (max-w-3xl with px-6)
    - Weekend number displayed as zero-padded two digits (01, 02...) for visual rhythm, except Bonus
    - Use rounded-xl for Apple-like card corners
